...
const SuggestedVideoCards = ({video}) => {
  return (
    <>
      <Link to={`/video/${video?.videoId}`}>
        <div className=" flex mb-3 ">
          <div className="relative h-24 lg:h-20 xl:h-24 w-40 min-w-[168px] lg:min-w-[128px] xl:w-40 xl:min-w-[168px] rounder-xl bg-slate-800 overflow-hidden cursor-pointer ">
            <img
